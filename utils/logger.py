...
from typing import Any, List, Sequence, TextIO, Dict, Optional, Tuple, Union
...
class Logger:
    ...
    def record_dict(self, data: dict, prefix: str = ""):
        for key, value in data.items():
            self.record(prefix + key, value)
...
class SummaryBoard:
    ...
    def update_from_result_dict(self, result_dict):
        ...
        for key, value in result_dict.items():
            if key not in self.meter_names:
